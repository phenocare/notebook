...
devtools::load_all("/Users/jul/git/jwist/fusion")
devtools::load_all("/Users/jul/gitea/phenocare/rolodex-samples")
set.seed(5474)
```
...
# 10x10 (Lettered) 
# as boxTypes.
manifest$boxName <- rep("box1", N)
manifest$boxType <- rep("10x10", N) 
