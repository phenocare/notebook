---
title: "external2 - cohortName - sampleMatrixType - comment - v0.2.0"
author: "Your Name"
date: "The Date"
output: 
  html_document:
...
# scripts/SRV02/scrapeNMRFolders_external.sh 
...
write.table(sampleDescriptionList, 
            file = paste0("sampleDescriptionList_", cleanNames(txt), ".ignore.tsv"), sep = "\t", dec = ".", row.names = FALSE)
```
